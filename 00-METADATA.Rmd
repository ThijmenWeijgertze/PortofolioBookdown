...
- If something goes wrong with downloading the dependencies automaticly try to install the dependencies manually
...
Installing dependency packages (if it doesn't download automatically please install the dependencies by hand):
```{r downloading and loading dependency packages}
...
- 20-appendices.Rmd: contains the appendix with the reproduced COVID-19 vaccin paper code
